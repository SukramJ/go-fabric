...
// switch.
// loom:reachable:reason="called through a type assertion in bridge when a cluster server is wired to its press source; an interface type has no construction site the analyzer can follow"
