...
var (
	_ mattercontract.ClusterServer                 = (*OperationalCredentials)(nil)
	_ mattercontract.FabricScopedReader            = (*OperationalCredentials)(nil)
	_ mattercontract.ClusterDataVersion            = (*OperationalCredentials)(nil)
	_ mattercontract.ClusterCommandLister          = (*OperationalCredentials)(nil)
	_ mattercontract.ClusterCommandInvokePrivilege = (*OperationalCredentials)(nil)
)
...
func (o *OperationalCredentials) MatterRead(attrID uint32) (any, bool) { //nolint:funlen // wire/dispatch table over many attribute/opcode cases
	...
	case opcredsAttrTrustedRootCertificates:
		...
		// immediately; go-fabric mirrors by prepending pendingTrustRootDER
...
func (o *OperationalCredentials) dispatchCmd(ctx context.Context, cmdID uint32, fields any) (any, error) {
	...
	return nil, im.UnsupportedCommandf("matter: OperationalCredentials command 0x%02X not supported", cmdID)
}
...
func (o *OperationalCredentials) handleAddNOC(ctx context.Context, fields any) (any, error) { //nolint:funlen // single-purpose NOC install handler with many validation/crypto branches
	...
	// Validate CaseAdminSubject BEFORE anything is persisted. Mirrors
	// chip OperationalCredentialsCluster.cpp:452-454:
	...
	// the identity (including its private key) and the IPK key set out of
