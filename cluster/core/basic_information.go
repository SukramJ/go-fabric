...
var (
	_ contract.ClusterServer                  = (*BasicInformation)(nil)
	_ contract.ClusterEventLister             = (*BasicInformation)(nil)
	_ contract.EventReceiver                  = (*BasicInformation)(nil)
	_ contract.ClusterDataVersion             = (*BasicInformation)(nil)
	_ contract.ClusterAttributeWritePrivilege = (*BasicInformation)(nil)
)
...
// every go-fabric instance running the same test VendorID+ProductID)
...
func (b *BasicInformation) MatterWrite(_ context.Context, attrID uint32, value any) error {
	...
	case basicInfoAttrLocation:
		...
		return nil
	case basicInfoAttrLocalConfigDisabled:
		// Persistent across reboots per Matter §11.1.6.17. go-fabric
...
// the emitter cleanly.
func (b *BasicInformation) SetMatterEventEmitter(emitter contract.EventEmitter) {
	b.mu.Lock()
	b.emitter = emitter
	b.mu.Unlock()
}
