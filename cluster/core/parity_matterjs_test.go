...
// go-fabric exposes carries the same ID, revision, and mandatory
// attribute set.
//
...
// parityCases enumerates every cluster go-fabric exposes on its root
...
// is the wire-level contract go-fabric honours.
	...
	return []parityCase{
		...
		},
		{
			...
			skipMandatoryIDs: []uint32{
				...
				// composition pattern; go-fabric's root + bridged
...
// cluster is implemented by go-fabric. A pair-abort
...
// TestParityMatterJS_NoSpuriousAttributes asserts go-fabric does NOT
...
// revisions are supplied by the host at bridge construction and verified
// here too.
