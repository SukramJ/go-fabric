...
func (f fakeFloat) MatterMeasurementClass() contract.MeasurementClass { return f.class }
...
func (f fakeBool) MatterMeasurementClass() contract.MeasurementClass { return f.class }
...
func (f *fakeFloatNotifier) MatterMeasurementClass() contract.MeasurementClass {
	return f.class
}
...
var (
	_ contract.ChangeNotifier = (*measurement.ElectricalPowerServer)(nil)
	_ contract.ChangeNotifier = (*measurement.ElectricalEnergyServer)(nil)
)
...
func TestTemperatureServerHappyPath(t *testing.T) {
	t.Parallel()
	src := fakeFloat{class: contract.MeasurementTemperature, val: 21.5, obs: true}
...
// contract.ClusterDataVersion capability the IM dispatcher uses.
...
func TestAirQualityServerClassifiesAgainstGuideline(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "co2 well ventilated", class: contract.MeasurementCO2, val: 425, obs: true, want: 1},
		{name: "co2 at guideline", class: contract.MeasurementCO2, val: 1000, obs: true, want: 1},
		{name: "co2 stale air", class: contract.MeasurementCO2, val: 1800, obs: true, want: 4},
		{name: "pm25 clean", class: contract.MeasurementPM25, val: 8, obs: true, want: 1},
		{name: "pm25 above guideline", class: contract.MeasurementPM25, val: 40, obs: true, want: 4},
...
func TestAirQualityServerGlobalAttributes(t *testing.T) {
	...
	s := measurement.NewAirQualityServer(
		...
		fakeFloat{class: contract.MeasurementCO2, val: 425, obs: true},
	)
...
func TestCO2ConcentrationServerHappyPath(t *testing.T) {
	t.Parallel()
	src := fakeFloat{class: contract.MeasurementCO2, val: 425.0, obs: true}
...
func TestPM25ConcentrationServerHappyPath(t *testing.T) {
	t.Parallel()
	src := fakeFloat{class: contract.MeasurementPM25, val: 42.5, obs: true}
...
func TestPM10ConcentrationServerHappyPath(t *testing.T) {
	t.Parallel()
	src := fakeFloat{class: contract.MeasurementPM10, val: 65.0, obs: true}
...
func TestPowerSourceServerStatusActive(t *testing.T) {
	t.Parallel()
	s := measurement.NewPowerSourceServer(fakeBool{class: contract.MeasurementBattery, val: false, obs: true})
...
func TestPowerSourceServerBatChargeWarning(t *testing.T) {
	t.Parallel()
	s := measurement.NewPowerSourceServer(fakeBool{class: contract.MeasurementBattery, val: true, obs: true})
	v, ok := s.MatterRead(0x000E)
	if !ok {
		t.Fatal("MatterRead(0x000E) ok = false")
	}
...
func TestPowerSourceServerBatChargeUnobservedDefaultsToOK(t *testing.T) {
	t.Parallel()
	s := measurement.NewPowerSourceServer(fakeBool{class: contract.MeasurementBattery, val: false, obs: false})
	v, ok := s.MatterRead(0x000E)
	if !ok {
...
func TestPowerSourceServerFromFloat_BatPercentRemaining(t *testing.T) {
	t.Parallel()
	s := measurement.NewPowerSourceServerFromFloat(fakeFloat{class: contract.MeasurementBattery, val: 42.3, obs: true})
...
func TestPowerSourceServerFromFloat_BatPercentRemaining_Unobserved(t *testing.T) {
	t.Parallel()
	s := measurement.NewPowerSourceServerFromFloat(fakeFloat{class: contract.MeasurementBattery, val: 0, obs: false})
	v, ok := s.MatterRead(0x000C)
	if !ok {
...
func TestPowerSourceServerFromFloat_BatPercentRemaining_Clamped(t *testing.T) {
	...
	for _, tc := range tests {
		s := measurement.NewPowerSourceServerFromFloat(fakeFloat{class: contract.MeasurementBattery, val: tc.pct, obs: true})
		v, ok := s.MatterRead(0x000C)
		if !ok {
...
func TestPowerSourceServerFromFloat_MatterAttributesIncludesBatPercentRemaining(t *testing.T) {
	t.Parallel()
	s := measurement.NewPowerSourceServerFromFloat(fakeFloat{class: contract.MeasurementBattery, val: 50, obs: true})
	...
	rows := []row{
		{
			...
			class:   contract.MeasurementCO2,
			src:     fakeFloat{class: contract.MeasurementCO2, val: 800.0, obs: true},
			wantIDs: []uint32{0x005B, 0x040D},
		},
		{
			name:    "PM25+fakeFloat→0x005B+0x042A",
			class:   contract.MeasurementPM25,
			src:     fakeFloat{class: contract.MeasurementPM25, val: 15.0, obs: true},
			wantIDs: []uint32{0x005B, 0x042A},
		},
		{
			name:    "PM10+fakeFloat→0x005B+0x042D",
			class:   contract.MeasurementPM10,
			src:     fakeFloat{class: contract.MeasurementPM10, val: 30.0, obs: true},
			wantIDs: []uint32{0x005B, 0x042D},
		},
		{
			name:    "Battery+fakeBool→0x002F",
			class:   contract.MeasurementBattery,
		...
		},
		{
			...
			class:   contract.MeasurementCO2,
			src:     fakeBool{class: contract.MeasurementCO2, val: false, obs: true},
			wantNil: true,
		},
		{
...
func TestElectricalPowerServerHappyPath(t *testing.T) {
	t.Parallel()
	src := fakeFloat{class: contract.MeasurementPower, val: 1500.0, obs: true}
...
func TestElectricalEnergyServerHappyPath(t *testing.T) {
	t.Parallel()
	src := fakeFloat{class: contract.MeasurementEnergy, val: 12345.0, obs: true}
...
func TestElectricalPowerServerOnMatterValueChangedForwards(t *testing.T) {
	t.Parallel()
	src := &fakeFloatNotifier{class: contract.MeasurementPower, val: 1500.0, obs: true}
	s := measurement.NewElectricalPowerServer(src)
...
func TestElectricalEnergyServerOnMatterValueChangedForwards(t *testing.T) {
	t.Parallel()
	src := &fakeFloatNotifier{class: contract.MeasurementEnergy, val: 12345.0, obs: true}
	s := measurement.NewElectricalEnergyServer(src)
...
// contract.ClusterDataVersion interface. The random-init rationale
