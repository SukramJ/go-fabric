...
func TestOccupancySensingServer_MatterRead_Unobserved(t *testing.T) {
	t.Parallel()
	s := measurement.NewOccupancySensingServer(fakeBool{class: contract.MeasurementOccupancy, val: false, obs: false})
...
func TestOccupancySensingServer_MatterRead_OccupancySensorType(t *testing.T) {
	t.Parallel()
	s := measurement.NewOccupancySensingServer(fakeBool{class: contract.MeasurementOccupancy, val: true, obs: true})
