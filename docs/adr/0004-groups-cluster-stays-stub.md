# ADR 0004 — Minimal in-memory Groups cluster: rejected (stub is a deliberate, matter.js-conformant divergence)

> **Provenance.** Moved here from OpenCCU-Loom, where this decision was
> recorded as ADR 0033 while the Matter stack still lived in that
