# ADR 0003 — Sigma resumption extraction: already satisfied (finding corrected)

> **Provenance.** Moved here from OpenCCU-Loom, where this decision was
> recorded as ADR 0032 while the Matter stack still lived in that
