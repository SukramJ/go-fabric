# ADR 0001 — Matter wire-protocol design rules from chip-tool bring-up

> **Provenance.** Moved here from OpenCCU-Loom, where this decision was
> recorded as ADR 0013 while the Matter stack still lived in that
...
- **Date:** 2026-05-06
- **Supersedes:** none
- **Related:** [OpenCCU-Loom ADR 0012 — Matter pure-Go implementation](https://github.com/SukramJ/openccu-loom/blob/main/docs/adr/0012-matter-pure-go-implementation.md)
