...
// loom:reachable:reason="constructed by the probe in this file and consumed through HealthRecorder, which the host satisfies with a translating adapter; interface satisfaction is invisible to the analyzer"
